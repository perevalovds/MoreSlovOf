...
//Auto-generated GUI file for ofxKuTextGui, 2021-11-06-14-31-26-814
...
void Parameters::setup(ofxKuTextGui &gui, string fileName) {
	...
	gui.addDummy("LPD8");
	gui.addString("*LPD_midi_in",_LPD_midi_in_,"LPD");
	gui.addDummy("");
	gui.addString("-APC_status",APC_status_,"...");
	gui.addString("-LPD_status",LPD_status_,"...");
	...
	gui.addDummy("");
	gui.addInt("BPM_1",BPM_1,120,60,200,1,10);
	gui.addInt("BPM_2",BPM_2,120,60,200,1,10);
	...
	gui.addStringList("REC",REC,0,12,"Techno1","Techno2","Techno3","Techno4","Techno5","Techno6","Techno7","Techno8","Techno9","Techno10","Techno11","Techno12");
	gui.addTab();
	gui.addDummy("Techno1");
	gui.addStringList("REC1",REC1,0,2,"OFF","ON");
	gui.addStringList("TEMP1",TEMP1,0,2,"SLOW","FAST");
	...
	gui.addFloat("w_reso1",w_reso1,0.5,0,1,200,20);
	gui.addDummy("Morph");
	...
	gui.addStringList("TEMP2",TEMP2,0,2,"SLOW","FAST");
	...
	gui.addFloat("w_reso2",w_reso2,0.5,0,1,200,20);
	gui.addDummy("Morph");
	...
	gui.addStringList("TEMP3",TEMP3,0,2,"SLOW","FAST");
	...
	gui.addFloat("w_reso3",w_reso3,0.5,0,1,200,20);
	gui.addDummy("Morph");
	...
	gui.addStringList("TEMP4",TEMP4,0,2,"SLOW","FAST");
	...
	gui.addFloat("w_reso4",w_reso4,0.5,0,1,200,20);
	gui.addDummy("Morph");
	...
	gui.addStringList("TEMP5",TEMP5,0,2,"SLOW","FAST");
	...
	gui.addFloat("w_reso5",w_reso5,0.5,0,1,200,20);
	gui.addDummy("Morph");
	...
	gui.addStringList("TEMP6",TEMP6,0,2,"SLOW","FAST");
	...
	gui.addFloat("w_reso6",w_reso6,0.5,0,1,200,20);
	gui.addDummy("Morph");
	...
	gui.addVar("REC");
	gui.addDummy("Load");
	gui.addButton("load1",load1);
	gui.addButton("load2",load2);
	gui.addButton("load3",load3);
	gui.addButton("load4",load4);
	gui.addButton("load5",load5);
	gui.addButton("load6",load6);
	gui.addStringList("load_to",load_to,0,6,"TECHNO7","TECHNO8","TECHNO9","TECHNO10","TECHNO11","TECHNO12");
	gui.addTab();
	gui.addDummy("Techno7");
	gui.addStringList("REC7",REC7,0,2,"OFF","ON");
	gui.addStringList("TEMP7",TEMP7,0,2,"SLOW","FAST");
	...
	gui.addFloat("w_reso7",w_reso7,0.5,0,1,200,20);
	gui.addDummy("Morph_Effects");
	...
	gui.addStringList("TEMP8",TEMP8,0,2,"SLOW","FAST");
	...
	gui.addDummy("Filter");
	gui.addStringList("w_flt8",w_flt8,0,4,"No","Lopass","Bandpass","Hipass");
	gui.addFloat("w_cutoff8",w_cutoff8,0.5,0,1,200,20);
	gui.addFloat("w_reso8",w_reso8,0.5,0,1,200,20);
	gui.addDummy("Morph_Effects");
	gui.addStringList("w_morph8",w_morph8,0,4,"file1","file2","file3","file4");
	gui.addInt("w_percent8",w_percent8,0,0,100,1,10);
	gui.addFloat("w_fxA8",w_fxA8,0,0,1,100,10);
	gui.addFloat("w_fxB8",w_fxB8,0,0,1,100,10);
	gui.addDummy("Vol-Pos");
	...
	gui.addStringList("TEMP9",TEMP9,0,2,"SLOW","FAST");
	...
	gui.addDummy("Filter");
	gui.addStringList("w_flt9",w_flt9,0,4,"No","Lopass","Bandpass","Hipass");
	gui.addFloat("w_cutoff9",w_cutoff9,0.5,0,1,200,20);
	gui.addFloat("w_reso9",w_reso9,0.5,0,1,200,20);
	gui.addDummy("Morph_Effects");
	gui.addStringList("w_morph9",w_morph9,0,4,"file1","file2","file3","file4");
	gui.addInt("w_percent9",w_percent9,0,0,100,1,10);
	gui.addFloat("w_fxA9",w_fxA9,0,0,1,100,10);
	gui.addFloat("w_fxB9",w_fxB9,0,0,1,100,10);
	gui.addDummy("Vol-Pos");
	...
	gui.addStringList("TEMP10",TEMP10,0,2,"SLOW","FAST");
	...
	gui.addDummy("Filter");
	gui.addStringList("w_flt10",w_flt10,0,4,"No","Lopass","Bandpass","Hipass");
	gui.addFloat("w_cutoff10",w_cutoff10,0.5,0,1,200,20);
	gui.addFloat("w_reso10",w_reso10,0.5,0,1,200,20);
	gui.addDummy("Morph_Effects");
	gui.addStringList("w_morph10",w_morph10,0,4,"file1","file2","file3","file4");
	gui.addInt("w_percent10",w_percent10,0,0,100,1,10);
	gui.addFloat("w_fxA10",w_fxA10,0,0,1,100,10);
	gui.addFloat("w_fxB10",w_fxB10,0,0,1,100,10);
	gui.addDummy("Vol-Pos");
	...
	gui.addStringList("TEMP11",TEMP11,0,2,"SLOW","FAST");
	...
	gui.addDummy("Filter");
	gui.addStringList("w_flt11",w_flt11,0,4,"No","Lopass","Bandpass","Hipass");
	gui.addFloat("w_cutoff11",w_cutoff11,0.5,0,1,200,20);
	gui.addFloat("w_reso11",w_reso11,0.5,0,1,200,20);
	gui.addDummy("Morph_Effects");
	gui.addStringList("w_morph11",w_morph11,0,4,"file1","file2","file3","file4");
	gui.addInt("w_percent11",w_percent11,0,0,100,1,10);
	gui.addFloat("w_fxA11",w_fxA11,0,0,1,100,10);
	gui.addFloat("w_fxB11",w_fxB11,0,0,1,100,10);
	gui.addDummy("Vol-Pos");
	...
	gui.addStringList("TEMP12",TEMP12,0,2,"SLOW","FAST");
	...
	gui.addDummy("Filter");
	gui.addStringList("w_flt12",w_flt12,0,4,"No","Lopass","Bandpass","Hipass");
	gui.addFloat("w_cutoff12",w_cutoff12,0.5,0,1,200,20);
	gui.addFloat("w_reso12",w_reso12,0.5,0,1,200,20);
	gui.addDummy("Morph_Effects");
	gui.addStringList("w_morph12",w_morph12,0,4,"file1","file2","file3","file4");
	gui.addInt("w_percent12",w_percent12,0,0,100,1,10);
	gui.addFloat("w_fxA12",w_fxA12,0,0,1,100,10);
	gui.addFloat("w_fxB12",w_fxB12,0,0,1,100,10);
	gui.addDummy("Vol-Pos");
	...
	gui.addStringList("w_flttype1",w_flttype1,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp1",w_fltstp1,1,1,64,1,10);
	gui.addFloat("w_fltmov1",w_fltmov1,0.5,0,1,100,10);
	gui.addDummy("LFO_7");
	...
	gui.addStringList("w_flttype7",w_flttype7,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp7",w_fltstp7,7,1,64,1,10);
	gui.addFloat("w_fltmov7",w_fltmov7,0.5,0,1,100,10);
	gui.addTab();
	gui.addDummy("LFO_2");
	...
	gui.addStringList("w_flttype2",w_flttype2,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp2",w_fltstp2,1,1,64,1,10);
	gui.addFloat("w_fltmov2",w_fltmov2,0.5,0,1,100,10);
	gui.addDummy("LFO_8");
	gui.addStringList("w_voltype8",w_voltype8,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_volstp8",w_volstp8,1,1,64,1,10);
	gui.addFloat("w_volmov8",w_volmov8,0.5,0,1,100,10);
	gui.addStringList("w_pantype8",w_pantype8,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_panstp8",w_panstp8,1,1,64,1,10);
	gui.addFloat("w_panmov8",w_panmov8,0.5,0,1,100,10);
	gui.addStringList("w_flttype8",w_flttype8,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp8",w_fltstp8,1,1,64,1,10);
	gui.addFloat("w_fltmov8",w_fltmov8,0.5,0,1,100,10);
	gui.addTab();
	gui.addDummy("LFO_3");
	...
	gui.addStringList("w_flttype3",w_flttype3,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp3",w_fltstp3,1,1,64,1,10);
	gui.addFloat("w_fltmov3",w_fltmov3,0.5,0,1,100,10);
	gui.addDummy("LFO_9");
	gui.addStringList("w_voltype9",w_voltype9,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_volstp9",w_volstp9,1,1,64,1,10);
	gui.addFloat("w_volmov9",w_volmov9,0.5,0,1,100,10);
	gui.addStringList("w_pantype9",w_pantype9,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_panstp9",w_panstp9,1,1,64,1,10);
	gui.addFloat("w_panmov9",w_panmov9,0.5,0,1,100,10);
	gui.addStringList("w_flttype9",w_flttype9,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp9",w_fltstp9,1,1,64,1,10);
	gui.addFloat("w_fltmov9",w_fltmov9,0.5,0,1,100,10);
	gui.addTab();
	gui.addDummy("LFO_4");
	...
	gui.addStringList("w_flttype4",w_flttype4,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp4",w_fltstp4,1,1,64,1,10);
	gui.addFloat("w_fltmov4",w_fltmov4,0.5,0,1,100,10);
	gui.addDummy("LFO_10");
	gui.addStringList("w_voltype10",w_voltype10,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_volstp10",w_volstp10,1,1,64,1,10);
	gui.addFloat("w_volmov10",w_volmov10,0.5,0,1,100,10);
	gui.addStringList("w_pantype10",w_pantype10,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_panstp10",w_panstp10,1,1,64,1,10);
	gui.addFloat("w_panmov10",w_panmov10,0.5,0,1,100,10);
	gui.addStringList("w_flttype10",w_flttype10,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp10",w_fltstp10,1,1,64,1,10);
	gui.addFloat("w_fltmov10",w_fltmov10,0.5,0,1,100,10);
	gui.addTab();
	gui.addDummy("LFO_5");
	...
	gui.addStringList("w_flttype5",w_flttype5,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp5",w_fltstp5,1,1,64,1,10);
	gui.addFloat("w_fltmov5",w_fltmov5,0.5,0,1,100,10);
	gui.addDummy("LFO_11");
	gui.addStringList("w_voltype11",w_voltype11,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_volstp11",w_volstp11,1,1,64,1,10);
	gui.addFloat("w_volmov11",w_volmov11,0.5,0,1,100,10);
	gui.addStringList("w_pantype11",w_pantype11,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_panstp11",w_panstp11,1,1,64,1,10);
	gui.addFloat("w_panmov11",w_panmov11,0.5,0,1,100,10);
	gui.addStringList("w_flttype11",w_flttype11,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp11",w_fltstp11,1,1,64,1,10);
	gui.addFloat("w_fltmov11",w_fltmov11,0.5,0,1,100,10);
	gui.addTab();
	gui.addDummy("LFO_6");
	...
	gui.addStringList("w_flttype6",w_flttype6,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp6",w_fltstp6,1,1,64,1,10);
	gui.addFloat("w_fltmov6",w_fltmov6,0.5,0,1,100,10);
	gui.addDummy("LFO_12");
	gui.addStringList("w_voltype12",w_voltype12,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_volstp12",w_volstp12,1,1,64,1,10);
	gui.addFloat("w_volmov12",w_volmov12,0.5,0,1,100,10);
	gui.addStringList("w_pantype12",w_pantype12,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_panstp12",w_panstp12,1,1,64,1,10);
	gui.addFloat("w_panmov12",w_panmov12,0.5,0,1,100,10);
	gui.addStringList("w_flttype12",w_flttype12,0,8,"const","up","down","rand","sin","-sin","cos","-cos");
	gui.addInt("w_fltstp12",w_fltstp12,1,1,64,1,10);
	gui.addFloat("w_fltmov12",w_fltmov12,0.5,0,1,100,10);
	...
	gui.set_var_color("*LPD_midi_in", ofColor(100,100,255));
	gui.set_var_color("-APC_status", ofColor(255,255,100));
	gui.set_var_color("-LPD_status", ofColor(255,255,100));
	...
	gui.set_var_color("BPM_1", ofColor(100,100,255));
	gui.set_var_color("BPM_2", ofColor(100,100,255));
	...
	gui.set_var_color("TEMP1", ofColor(100,200,100));
	...
	gui.set_var_color("w_reso1", ofColor(255,255,100));
	...
	gui.set_var_color("TEMP2", ofColor(100,200,100));
	...
	gui.set_var_color("w_reso2", ofColor(255,255,100));
	...
	gui.set_var_color("TEMP3", ofColor(100,200,100));
	...
	gui.set_var_color("w_reso3", ofColor(255,255,100));
	...
	gui.set_var_color("TEMP4", ofColor(100,200,100));
	...
	gui.set_var_color("w_reso4", ofColor(255,255,100));
	...
	gui.set_var_color("TEMP5", ofColor(100,200,100));
	...
	gui.set_var_color("w_reso5", ofColor(255,255,100));
	...
	gui.set_var_color("TEMP6", ofColor(100,200,100));
	...
	gui.set_var_color("w_reso6", ofColor(255,255,100));
	...
	gui.set_var_color("load1", ofColor(200,200,200));
	gui.set_var_color("load2", ofColor(200,200,200));
	gui.set_var_color("load3", ofColor(200,200,200));
	gui.set_var_color("load4", ofColor(200,200,200));
	gui.set_var_color("load5", ofColor(200,200,200));
	gui.set_var_color("load6", ofColor(200,200,200));
	gui.set_var_color("load_to", ofColor(200,200,200));
	gui.set_var_color("REC7", ofColor(100,100,255));
	gui.set_var_color("TEMP7", ofColor(100,200,100));
	...
	gui.set_var_color("w_flt7", ofColor(100,100,255));
	gui.set_var_color("w_cutoff7", ofColor(255,255,100));
	gui.set_var_color("w_reso7", ofColor(255,255,100));
	gui.set_var_color("w_morph7", ofColor(150,150,150));
	gui.set_var_color("w_percent7", ofColor(255,255,100));
	...
	gui.set_var_color("TEMP8", ofColor(100,200,100));
	...
	gui.set_var_color("w_flt8", ofColor(100,100,255));
	gui.set_var_color("w_cutoff8", ofColor(255,255,100));
	gui.set_var_color("w_reso8", ofColor(255,255,100));
	gui.set_var_color("w_morph8", ofColor(150,150,150));
	gui.set_var_color("w_percent8", ofColor(255,255,100));
	gui.set_var_color("w_fxA8", ofColor(100,100,255));
	gui.set_var_color("w_fxB8", ofColor(100,100,255));
	gui.set_var_color("w_louder8", ofColor(150,150,150));
	gui.set_var_color("w_pan8", ofColor(150,150,150));
	gui.set_var_color("w_vol8", ofColor(255,255,100));
	gui.set_var_color("w_pos8", ofColor(255,100,255));
	gui.set_var_color("REC9", ofColor(100,100,255));
	gui.set_var_color("TEMP9", ofColor(100,200,100));
	...
	gui.set_var_color("w_flt9", ofColor(100,100,255));
	gui.set_var_color("w_cutoff9", ofColor(255,255,100));
	gui.set_var_color("w_reso9", ofColor(255,255,100));
	gui.set_var_color("w_morph9", ofColor(150,150,150));
	gui.set_var_color("w_percent9", ofColor(255,255,100));
	gui.set_var_color("w_fxA9", ofColor(100,100,255));
	gui.set_var_color("w_fxB9", ofColor(100,100,255));
	gui.set_var_color("w_louder9", ofColor(150,150,150));
	gui.set_var_color("w_pan9", ofColor(150,150,150));
	gui.set_var_color("w_vol9", ofColor(255,255,100));
	gui.set_var_color("w_pos9", ofColor(255,100,255));
	gui.set_var_color("REC10", ofColor(100,100,255));
	gui.set_var_color("TEMP10", ofColor(100,200,100));
	...
	gui.set_var_color("w_flt10", ofColor(100,100,255));
	gui.set_var_color("w_cutoff10", ofColor(255,255,100));
	gui.set_var_color("w_reso10", ofColor(255,255,100));
	gui.set_var_color("w_morph10", ofColor(150,150,150));
	gui.set_var_color("w_percent10", ofColor(255,255,100));
	gui.set_var_color("w_fxA10", ofColor(100,100,255));
	gui.set_var_color("w_fxB10", ofColor(100,100,255));
	gui.set_var_color("w_louder10", ofColor(150,150,150));
	...
	gui.set_var_color("TEMP11", ofColor(100,200,100));
	...
	gui.set_var_color("w_flt11", ofColor(100,100,255));
	gui.set_var_color("w_cutoff11", ofColor(255,255,100));
	gui.set_var_color("w_reso11", ofColor(255,255,100));
	gui.set_var_color("w_morph11", ofColor(150,150,150));
	gui.set_var_color("w_percent11", ofColor(255,255,100));
	gui.set_var_color("w_fxA11", ofColor(100,100,255));
	gui.set_var_color("w_fxB11", ofColor(100,100,255));
	...
	gui.set_var_color("TEMP12", ofColor(100,200,100));
	...
	gui.set_var_color("w_flt12", ofColor(100,100,255));
	gui.set_var_color("w_cutoff12", ofColor(255,255,100));
	gui.set_var_color("w_reso12", ofColor(255,255,100));
	gui.set_var_color("w_morph12", ofColor(150,150,150));
	gui.set_var_color("w_percent12", ofColor(255,255,100));
	gui.set_var_color("w_fxA12", ofColor(100,100,255));
	gui.set_var_color("w_fxB12", ofColor(100,100,255));
	gui.set_var_color("w_louder12", ofColor(150,150,150));
	gui.set_var_color("w_pan12", ofColor(150,150,150));
	gui.set_var_color("w_vol12", ofColor(255,255,100));
	gui.set_var_color("w_pos12", ofColor(255,100,255));
	...
	gui.set_var_color("w_flttype1", ofColor(100,255,100));
	gui.set_var_color("w_fltstp1", ofColor(128,160,128));
	gui.set_var_color("w_fltmov1", ofColor(128,160,128));
	...
	gui.set_var_color("w_flttype7", ofColor(100,255,100));
	gui.set_var_color("w_fltstp7", ofColor(128,160,128));
	gui.set_var_color("w_fltmov7", ofColor(128,160,128));
	...
	gui.set_var_color("w_flttype2", ofColor(100,255,100));
	gui.set_var_color("w_fltstp2", ofColor(128,160,128));
	gui.set_var_color("w_fltmov2", ofColor(128,160,128));
	gui.set_var_color("w_voltype8", ofColor(100,100,255));
	gui.set_var_color("w_volstp8", ofColor(100,100,255));
	gui.set_var_color("w_volmov8", ofColor(100,100,255));
	gui.set_var_color("w_pantype8", ofColor(100,100,255));
	gui.set_var_color("w_panstp8", ofColor(100,100,255));
	gui.set_var_color("w_panmov8", ofColor(100,100,255));
	gui.set_var_color("w_flttype8", ofColor(100,255,100));
	gui.set_var_color("w_fltstp8", ofColor(128,160,128));
	gui.set_var_color("w_fltmov8", ofColor(128,160,128));
	...
	gui.set_var_color("w_flttype3", ofColor(100,255,100));
	gui.set_var_color("w_fltstp3", ofColor(128,160,128));
	gui.set_var_color("w_fltmov3", ofColor(128,160,128));
	gui.set_var_color("w_voltype9", ofColor(100,100,255));
	gui.set_var_color("w_volstp9", ofColor(100,100,255));
	gui.set_var_color("w_volmov9", ofColor(100,100,255));
	gui.set_var_color("w_pantype9", ofColor(100,100,255));
	gui.set_var_color("w_panstp9", ofColor(100,100,255));
	gui.set_var_color("w_panmov9", ofColor(100,100,255));
	gui.set_var_color("w_flttype9", ofColor(100,255,100));
	gui.set_var_color("w_fltstp9", ofColor(128,160,128));
	gui.set_var_color("w_fltmov9", ofColor(128,160,128));
	...
	gui.set_var_color("w_flttype4", ofColor(100,255,100));
	gui.set_var_color("w_fltstp4", ofColor(128,160,128));
	gui.set_var_color("w_fltmov4", ofColor(128,160,128));
	gui.set_var_color("w_voltype10", ofColor(100,100,255));
	gui.set_var_color("w_volstp10", ofColor(100,100,255));
	gui.set_var_color("w_volmov10", ofColor(100,100,255));
	gui.set_var_color("w_pantype10", ofColor(100,100,255));
	gui.set_var_color("w_panstp10", ofColor(100,100,255));
	gui.set_var_color("w_panmov10", ofColor(100,100,255));
	gui.set_var_color("w_flttype10", ofColor(100,255,100));
	gui.set_var_color("w_fltstp10", ofColor(128,160,128));
	gui.set_var_color("w_fltmov10", ofColor(128,160,128));
	...
	gui.set_var_color("w_flttype5", ofColor(100,255,100));
	gui.set_var_color("w_fltstp5", ofColor(128,160,128));
	gui.set_var_color("w_fltmov5", ofColor(128,160,128));
	gui.set_var_color("w_voltype11", ofColor(100,100,255));
	gui.set_var_color("w_volstp11", ofColor(100,100,255));
	gui.set_var_color("w_volmov11", ofColor(100,100,255));
	gui.set_var_color("w_pantype11", ofColor(100,100,255));
	gui.set_var_color("w_panstp11", ofColor(100,100,255));
	gui.set_var_color("w_panmov11", ofColor(100,100,255));
	gui.set_var_color("w_flttype11", ofColor(100,255,100));
	gui.set_var_color("w_fltstp11", ofColor(128,160,128));
	gui.set_var_color("w_fltmov11", ofColor(128,160,128));
	...
	gui.set_var_color("w_flttype6", ofColor(100,255,100));
	gui.set_var_color("w_fltstp6", ofColor(128,160,128));
	gui.set_var_color("w_fltmov6", ofColor(128,160,128));
	gui.set_var_color("w_voltype12", ofColor(100,100,255));
	gui.set_var_color("w_volstp12", ofColor(100,100,255));
	gui.set_var_color("w_volmov12", ofColor(100,100,255));
	gui.set_var_color("w_pantype12", ofColor(100,100,255));
	gui.set_var_color("w_panstp12", ofColor(100,100,255));
	gui.set_var_color("w_panmov12", ofColor(100,100,255));
	gui.set_var_color("w_flttype12", ofColor(100,255,100));
	gui.set_var_color("w_fltstp12", ofColor(128,160,128));
	gui.set_var_color("w_fltmov12", ofColor(128,160,128));
